...
if __name__ == "__main__":
    ...
    input_dir = 'Master Netverk/LSUI/input'  # Path to training images
    gt_dir = 'Master Netverk/LSUI/GT'      # Path to validation images
    ...
    model.save("modelpoolingMSE.h5")
    model.save("modelpoolingMSE.keras")
