...
model_path = "MasterNetverk/Netverk_med_Vitis_tilpass/modelSimple512Working100e.h5"  # Replace with your actual model file
...
# input_shape = [1, 256, 256, 3]  # Batch size 1, 256x256 input size, 3 channels
# average_time = measure_inference_speed(model, input_shape)
# # Example usage
# flops = calculate_flops_updated(model, input_shape)
